...
<section class=" ">
    <div class="flex flex-col items-center  px-6 py-8 mx-auto md:h-screen lg:py-0">
      ...
      <div class="w-full bg-gray-100 rounded-2xl shadow  md:mt-0 sm:max-w-md xl:p-0 ">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8 mx-auto">
                <div className="flex justify-between pt-3">
                    <div>
                            <p className='text-center font-semibold text-lg pb-4'>Purge Near Expiry Items</p>
