        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-6 md:space-y-6" action="#">
              ...
              <div id="leftsyd" className='pr-10'>
                <div>
                    <label for="idnumber" class="block mb-2 font-medium text-gray-900 ">Your ID Number</label>
                    <div className='flex my-auto'>
                       ...
                       &nbsp;<Link href="/dashboard/add_to_database" mt-1> <button type="button" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 shadow-lg shadow-green-500/50  font-medium rounded-2xl px-3 py-1 text-center text-lg mr-2 mb-2">Search</button></Link>
                    </div>
                </div>
                <div>
                    <label for="firstName" class="block mb-2 mt-3 font-medium text-gray-900 ">Your First Name</label>
                ...
                <div>
                    <label for="lastName" class="block mb-2 mt-3 font-medium text-gray-900 ">Your Last Name</label>
              ...
              <div id="rightsyd">
                <div>
                    <label for="department" class="block mb-2 mt-1 font-medium text-gray-900 ">Your department</label>
                ...
                <div>
                    <label for="course" class="block mb-2 mt-3 font-medium text-gray-900 ">Your Course / Position</label>
                ...
                <div>
                    <label for="yearlevel" class="block mb-2 mt-3 font-medium text-gray-900 ">Your year level</label>
                ...
                <div>
                    <label for="symptom" class="block mb-2 font-medium text-gray-900 ">Sypmtom</label>
                    <textarea name="message" id="symptom" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Symptom" required=""/>
                </div>                
               <br/>

              <div className='flex justify-between'>
               <Link href="/dashboard"> <button type="button" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300  shadow-lg shadow-green-500/50  font-medium rounded-2xl text-xl px-5 py-2.5 text-center mr-2 mb-2">Cancel</button></Link>
               <Link href="/dashboard/patient_queueing"> <button type="button" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300  shadow-lg shadow-green-500/50  font-medium rounded-2xl text-xl px-5 py-2.5  text-center mr-2 mb-2">Admit Patient</button></Link>
               </div>
            </form>
        </div>
    </div>
