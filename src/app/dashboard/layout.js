    ...
    <div>
      ...
      <div id="sidebarandchildren" className="flex">
        ...
        <div id="sidebar" className="flex flex-col">
          <div className="p-10">
            <div>
              <Link href="/dashboard/patient_queue">
                {" "}
                <button
                  type="button"
                  class="text-white bg-gradient-to-r bg-green-400 hover:bg-green-600 active:bg-green-700 focus:outline-none focus:ring focus:ring-green-300 transition duration-300 ease-in-out font-medium rounded-lg px-5 py-2.5 text-center mr-2 mb-2 text-xl w-52"
                >
                  Patient Queue
                </button>
              </Link>
            ...
            <div>
              <Link href="/dashboard/manage_database">
                ...
                <button
                  type="button"
                  class="text-white bg-gradient-to-r bg-green-400 hover:bg-green-600 active:bg-green-700 focus:outline-none focus:ring focus:ring-green-300 transition duration-300 ease-in-out nt-medium rounded-lg text-xl px-5 py-2.5 text-center mr-2 mb-2 w-52"
                >
                  Manage Database
                </button>
              </Link>
          ...
          <div className="bg-green-700 flex py-5 justify-between items-center px-16">
            <div>
              <p className="text-lime-500">
                © Copyright <strong> UCode Clinic </strong>- All Rights Reserved
              </p>
            </div>
            <div className="flex">
              ...
              <Link href="http://www.instagram.com" className="ml-3 text-4xl ">
                {" "}
                <svg
                  className="fill-lime-500"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <Link href="http://www.twitter.com" className="ml-3 text-4xl ">
                {" "}
                <svg
                  className="fill-lime-500"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <Link href="http://www.linkedin.com" className="ml-3 text-4xl ">
                {" "}
                <svg
                  className="fill-lime-500"
                  xmlns="http://www.w3.org/2000/svg"
